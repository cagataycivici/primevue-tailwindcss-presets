export default {
  root: {
    class: [
      ...
      '[&>[data-pc-name=inputicon]:first-child]:start-3',
      '[&>[data-pc-name=inputicon]:last-child]:end-3',
      ...
      '[&>[data-pc-extend=inputicon]:first-child]:start-3',
      '[&>[data-pc-extend=inputicon]:last-child]:end-3',
    ],
  },
}
